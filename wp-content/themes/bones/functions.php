...
function bones_register_sidebars() {
  register_sidebar(array(
    'id' => 'sidebar-left',
    'name' => __('Vasen sivupalkki', 'bonestheme'),
    'description' => __('Vasen sivupalkki.', 'bonestheme'),
	...
	register_sidebar(array(
		'id' => 'sidebar-right',
		'name' => __('Oikea sivupalkki', 'bonestheme'),
		'description' => __('Oikea sivupalkki.', 'bonestheme'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
		...
		<article id="comment-<?php comment_ID(); ?>" class="clearfix">
			<header class="comment-author vcard">
				...
				*/
				...
				<time datetime="<?php echo comment_time('Y-m-j'); ?>"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php comment_time(__('F j, Y', 'bonestheme')); ?> </a></time>
  ...
  if (!is_home()) {
    ...
    if (is_category()) {
      ...
      the_title('<span class="current-crumb">', '</span>', true);
        ...
        echo '<span class="current-crumb">'. __("Posts By:", "bonestheme") . '<b>' . get_the_author_meta('display_name', $author_id) .'</b></span>';
     } 
    echo '</div>';
  }
